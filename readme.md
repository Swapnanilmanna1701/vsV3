...
Create Nodes: Drag node types from the "AVAILABLE NODES" section onto the canvas
Connect Nodes: Click and drag from one node's connection point to another node
Submit Pipeline: Click the "SUBMIT PIPELINE" button to analyze your workflow
View Results: An alert will display:
...
The production server will serve the built frontend on port 5000
Troubleshooting
